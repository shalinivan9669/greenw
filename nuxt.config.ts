    ...
    head: {
      ...
      meta: [
        ...
        },
        {
          name: 'keywords',
          content:
            'Реклама, Реклама в лифтах Караганда, Реклама в Караганде, Реклама Караганада, GREENWAY, реклама в лифтах Темертау, рекламное агентство Караганда, Рекламные стенды Караганда, размещение рекламы, рекламные услуги Караганда',
        },
