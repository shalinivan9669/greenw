    ...
    <div class="container mx-auto text-center px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
        <div class="bg-[#efefef] rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
          <img :src="sale" alt="Реклама Акции и распродажи в Караганде" class="mx-auto h-40 mb-4">
          <p>Планируете провести акцию или распродажу</p>
        </div>
        <div class="bg-[#efefef] rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
          <img :src="staff" alt="Реклама вакансий" class="mx-auto h-40 mb-4">
          <p>Необходимо привлечь квалифицированный персонал</p>
        </div>
        <div class="bg-[#efefef] rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
          <img :src="money" alt="Рекламный бюджет" class="mx-auto h-40 mb-4">
          <p>Ограничен рекламный бюджет</p>
        </div>
        <div class="bg-[#efefef] rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
          <img :src="medal" alt="Реклама лучше конкурентов" class="mx-auto h-40 mb-4">
          <p>Хотите быть на шаг впереди конкурентов</p>
        </div>
        <div class="bg-[#efefef] rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
          <img :src="people" alt="Привлечение клиентов через рекламу" class="mx-auto h-40 mb-4">
          <p>Нужен эффективный способ привлечения новых клиентов</p>
        </div>
        <div class="bg-[#efefef] rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
          <img :src="hand" alt="Повышение узнаваемости Бренда" class="mx-auto h-40 mb-4">
    ...
    <div class="container mx-auto text-center mt-16 px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-10 lg:grid-cols-3 lg:gap-16 text-left">
        <div class="flex items-start space-x-4 bg-[#efefef] rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
          <img :src="button" alt="Button" class="h-12">
          <div>
        ...
        <div class="flex items-start space-x-4 bg-[#efefef] rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
          <img :src="money" alt="Выгодная цена рекламы" class="h-12">
          <div>
        ...
        <div class="flex items-start space-x-4 bg-[#efefef] rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
          <img :src="people" alt="Новые площадки под рекламу" class="h-12">
          <div>
        ...
        <div class="flex items-start space-x-4 bg-[#efefef] rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
          <img :src="hand" alt="Реклама охватывающая людей в домах" class="h-12">
          <div>
        ...
        <div class="flex items-start space-x-4 bg-[#efefef] rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
          <img :src="button" alt="Частый контакт с рекламой" class="h-12">
          <div>
        ...
        <div class="flex items-start space-x-4 bg-[#efefef] rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
          <img :src="hand" alt="Быстрый эффект от рекламы" class="h-12">
          <div>
